...
class Modelv65(BaseModel):
    ...
    def create_folds(self, fold_name, seed):
        ...
        dtr, dte = super(Modelv65, self).create_fold(data, seed)
    ...
    def train(self, train, test, feature_list, is_eval, TARGET_NAME='TARGET', **params):
        ...
        return super(Modelv65, self).train_lgb(X, y, Xte, yte, **params) if self.params['model_type'] == 'LGB'\
               else super(Modelv65, self).train_xgb(X, y, Xte, yte, **params)
    ...
    def evaluate(self, test, feature_list, is_eval, model, TARGET_NAME='TARGET'):
        ...
        return super(Modelv65, self).evaluate_lgb(Xte, yte, model) if self.params['model_type'] == 'LGB'\
               else super(Modelv65, self).evaluate_xgb(Xte, yte, model)
    ...
    def get_sample(self, train, sample_size=.5, seed=SEED):
        ...
        """
        return super(Modelv65, self).get_sample(train, sample_size, seed=SEED)
    ...
    def oof_preds(self, train, feature_list, model):
        ...
        return super(Modelv65, self).oof_preds(X, y, model)

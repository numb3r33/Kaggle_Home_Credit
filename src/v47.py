...
class Modelv47(BaseModel):
    ...
    def load_data(self, filenames):
        ...
        df       = super(Modelv47, self).reduce_mem_usage(df)
    ...
    def create_folds(self, fold_name, seed):
        ...
        dtr, dte = super(Modelv47, self).create_fold(data, seed)
    ...
    def prepare_features(self, fold_name):
        ...
        if not os.path.exists(os.path.join(basepath, self.params['output_path'] + self.params['run_name'] + f'loan_stacking_{fold_name}train.pkl')):
            ...
            data = super(Modelv47, self).fill_infrequent_values(data)
    ...
    def train(self, train, test, feature_list, is_eval, **params):
        ...
        return super(Modelv47, self).train_lgb(X, y, Xte, yte, **params)
    ...
    def evaluate(self, test, feature_list, is_eval, model):
        ...
        return super(Modelv47, self).evaluate_lgb(Xte, yte, model)
    ...
    def get_sample(self, train, sample_size=.5):
        ...
        """
        return super(Modelv47, self).get_sample(train, sample_size)
...
if __name__ == '__main__':
    ...
    if args.p:
        ...
        if not is_eval:
            ...
            HOLDOUT_SCORE = (0.7932 + 0.7933 + 0.7886) / 3

...
class Modelv154(BaseModel):
    ...
    def reduce_mem_usage(self, df):
        return super(Modelv154, self).reduce_mem_usage(df)
    ...
    def train(self, train, test, feature_list, is_eval, TARGET_NAME='TARGET', **params):
        ...
        return super(Modelv154, self).train_log(X, y, Xte, yte, **params)
    ...
    def evaluate(self, test, feature_list, is_eval, model, TARGET_NAME='TARGET'):
        ...
        return super(Modelv154, self).evaluate_log(Xte, yte, model)


    def predict_test(self, train, test, feature_list, params, save_path, n_folds=5):
        return super(Modelv154, self).predict_test_xgb(train, test, feature_list, params, save_path, n_folds=n_folds)
    ...
    def cross_validate(self, train, feature_list, params, cv_adversarial_filepath=None, TARGET_NAME='TARGET'):
        ...
        return super(Modelv154, self).cross_validate_log(Xtr, ytr, params, cv_adversarial_filepath=cv_adversarial_filepath)
...
if __name__ == '__main__':
    ...
    if args.cv:
        ...
        train_filenames = [
                            ...
                            'v151_4457_oof_train_preds.npy',
                            'v153_4457_oof_train_preds.npy'
                          ]
        ...
        test_filenames  = [
                            ...
                            'v151_4457_test_preds.npy',
                            'v153_4457_test_preds.npy'
                          ]

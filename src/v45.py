...
class Modelv45(BaseModel):
    ...
    def load_data(self, filenames):
        ...
        df       = super(Modelv45, self).reduce_mem_usage(df)
    ...
    def create_folds(self, fold_name, seed):
        ...
        dtr, dte = super(Modelv45, self).create_fold(data, seed)
    ...
    def prepare_features(self, fold_name):
        ...
        if not os.path.exists(os.path.join(basepath, self.params['output_path'] + self.params['run_name'] + f'loan_stacking_{fold_name}train.pkl')):
            ...
            data = super(Modelv45, self).fill_infrequent_values(data)
    ...
    def train(self, train, test, feature_list, is_eval, **params):
        ...
        return super(Modelv45, self).train_lgb(X, y, Xte, yte, **params)
    ...
    def evaluate(self, test, feature_list, is_eval, model):
        ...
        return super(Modelv45, self).evaluate_lgb(Xte, yte, model)
    ...
    def get_sample(self, train, sample_size=.5):
        ...
        """
        return super(Modelv45, self).get_sample(train, sample_size)
...
if __name__ == '__main__':
    ...
    if args.p:
        ...
        if not is_eval:
            ...
            HOLDOUT_SCORE = (0.793 + 0.7925 + 0.7890) / 3

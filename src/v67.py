...
class Modelv67(BaseModel):
    ...
    def load_data(self, filenames):
        ...
        df       = super(Modelv67, self).reduce_mem_usage(df)
    ...
    def preprocess(self):
        ...
        if not os.path.exists(os.path.join(basepath, self.params['output_path'] + 'feature_groups/' + f'current_application_train.pkl')):
            ...
            data = super(Modelv67, self).fill_infrequent_values(data)
    ...
    def get_features(self, train, test, compute_ohe):
        ...
        if compute_ohe:
            data = super(Modelv67, self).prepare_ohe(data, OHE_COLS, drop_col=True)
        else:
    ...
    def train(self, train, test, feature_list, is_eval, TARGET_NAME='TARGET', **params):
        ...
        return super(Modelv67, self).train_lgb(X, y, Xte, yte, **params)
...
if __name__ == '__main__':
    ...
    if args.p:
        ...
        output_files = [os.path.join(basepath, 'submissions/20180714-0003-v67-0.7955457637350173_0.002634437556483681-1231.csv'),
                        os.path.join(basepath, 'submissions/20180714-0011-v67-0.7955457637350173_0.002634437556483681-2001.csv'),
                        os.path.join(basepath, 'submissions/20180714-0017-v67-0.7955457637350173_0.002634437556483681-2193.csv')                        
                       ]
